path_sd15 = './models/control_sd15_ini.ckpt'
path_sd15_with_control = './models/control_sd15_seg.pth'
path_input = '/data/dailei/Result/controlnet/models/checkpoints_NYS16_fine_256/epoch=20-step=7202.ckpt'
path_output = './models/control_NYS16_fine_256.pth'
