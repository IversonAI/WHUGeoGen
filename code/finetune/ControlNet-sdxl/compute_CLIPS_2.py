...
for s in size:
    for r in res:
        for d in data_name:
            ...
            path_name = f"/data/dailei/WHUGeoGen3/test/{s}/{r}/RS_images"
            # OUTPUT_DIR = f"whugeogenv2_outputs_{ckpt_path_name}_{RESOLUTION}_epoch5"
            # root_name = '/home/user/dailei/Code_4090/FreestyleNet/outputs_eval/WHUGeoGenv2_LIS_freestyle/WHUGeoGenv2_LIS_512'
            root_name = f"/data/dailei/WHUGeoGen3/whugeogenv2_t2i_sdxl_bj_ny_512_epoch5/sample_512"
            # output_name = f"{r}_{d}/"
