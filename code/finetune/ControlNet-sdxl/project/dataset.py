...
class SDXLDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print('/home/user/dailei/Code_4090/ControlNet-for-SDXL/train/' + source_filename)

        source = cv2.imread('/home/user/dailei/Code_4090/ControlNet-for-SDXL/train/' + source_filename)
        target = cv2.imread('/home/user/dailei/Code_4090/ControlNet-for-SDXL/train/' + target_filename)
