...
config_name=['RS_images','Annotations','Instance_masks','Semantic_masks']
data_name=['NewYork','BeiJing']
for sp in split:
    for s in size:
        for r in res:
            for c in config_name:
                for d in data_name:
                    source_folder = '/data/dailei/WHUGeoGen3'  # 源文件夹路径
                    destination_folder = f'/data/dailei/WHUGeoGen3/WHUGeoGen_Toy/{sp}/{s}/{r}/{c}/{d}'  # 目标文件夹路径
